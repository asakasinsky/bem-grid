({
    ...
    styles : [{ elem : 'css', url : '//rawgit.com/verybigman/bem-grid/gh-pages/promo.pages/index/_index.css' }],
    scripts : [{ elem : 'js', url : '//rawgit.com/verybigman/bem-grid/gh-pages/promo.pages/index/_index.js' }],
    content : [
        {
            elem : 'header',
            content : [

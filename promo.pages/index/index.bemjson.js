({
    ...
    styles : [{ elem : 'css', url : '//raw.githubusercontent.com/verybigman/bem-grid/gh-pages/promo.pages/index/_index.css' }],
    scripts : [{ elem : 'js', url : '//raw.githubusercontent.com/verybigman/bem-grid/gh-pages/promo.pages/index/_index.js' }],
    content : [
        {
            elem : 'header',
            content : [
